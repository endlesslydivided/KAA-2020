...
//				 120-131 - лексические ошибки
	ERROR error[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(121,	"[Лексическая] Слишком большое имя переменной или недопустимое имя переменной"),
		...
		ERROR_ENTRY(132, "[Семантическая] Имя идентификатора не может быть ключевым словом"),
		ERROR_ENTRY(133, "[Семантическая] Тип функции и тип возвращаемого значения отличаются"),
		ERROR_ENTRY(134, "[Семантическая] Несоответствие присваиваемого типа типу переменной"),
		ERROR_ENTRY(135, "[Семантическая] Наличие идентификатора строкового типа в целочисленном выражении"),
		ERROR_ENTRY(136, "[Семантическая] Запрещено присваивать значение функции"),
		ERROR_ENTRY(137, "[Семантическая] Неверное количество параметров вызываемой функции"),
		ERROR_ENTRY(138, "[Семантическая] Несоответствие параметров в вызываемой функции"),
		ERROR_ENTRY(139, "[Семантическая] Функция strlen должна принимать параметр типа string"),
		ERROR_ENTRY(140, "[Семантическая] Функция random должна принимать параметр типа uint"),
		ERROR_ENTRY(141, "[Семантическая] Функция ничего не возвращает"),
		ERROR_ENTRY(142, "[Семантическая] Нарушена структура программного блока"),
		ERROR_ENTRY(143, "[Лексическая] Недопустимая операция над данным типом"),
		ERROR_ENTRY(144, "[Семантическая] "),
		ERROR_ENTRY(145, "[Лексическая] Деление на ноль"),
		ERROR_ENTRY(146, "[Семантическая] Недопустимое значение переменной типа INT"),
		ERROR_ENTRY(147, "[Семантическая] Недопустимое значение переменной типа UINT"),
		ERROR_ENTRY(148, "[Семантическая] Недопустимое значение переменной типа CHAR"),
		ERROR_ENTRY(149, "[Семантическая] Нарушена форма логического выражения"),
		...
		ERROR_ENTRY(601,"[Синтаксическая] Ошибочный оператор"),
		ERROR_ENTRY(602,"[Синтаксическая] Ошибка в выражении"),
		ERROR_ENTRY(603,"[Синтаксическая] Ошибка в параметрах функции"),
		ERROR_ENTRY(604,"[Синтаксическая] Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(605,"[Синтаксическая] Ошибочное определение логического условия"),
