...
#define STRING_LITERAL(string) string, 3,	\
	...
	FST::NODE(143,	FST::RELATION(' ', 1),	\
					...
					FST::RELATION('Р', 1), FST::RELATION('М', 1),	FST::RELATION('Т', 1), FST::RELATION('У', 1),	\
...
#define CHAR_LITERAL(string) string, 3,	\
	...
	FST::NODE(143,	FST::RELATION(' ', 1),FST::RELATION('a', 1),FST::RELATION('b', 1),FST::RELATION('c', 1),	\
					...
					FST::RELATION('9', 1),FST::RELATION('а', 1),FST::RELATION('б', 1),FST::RELATION('в', 1),	\
					...
					FST::RELATION('ь', 1),FST::RELATION('ъ', 1),FST::RELATION('ы', 1),FST::RELATION('э', 1),	\
					FST::RELATION('ю', 1),FST::RELATION('я', 1),FST::RELATION('=', 1),FST::RELATION('+', 1),	\
					FST::RELATION('-', 1),FST::RELATION('*', 1),FST::RELATION('/', 1),FST::RELATION('(', 1),	\
					FST::RELATION(')', 1),FST::RELATION('{', 1),FST::RELATION('}', 1),FST::RELATION(';', 1),	\
